...
const Nav = () => {
  ...
  const masterSubMenu = [
    {
      ...
      submenu: [
        {
          text: "Product",
          onClick: () => console.log("Nested Subitem 1 clicked"),
          to: "/product",
        },
        {
          text: "Subscription",
          onClick: () => console.log("Nested Subitem 2 clicked"),
          to: "/subscription",
        },
        {
          text: "Brand",
    ...
    {
      text: "Nested Item 3",
      onClick: () => console.log("Nested Item 3 clicked"),
      to: "/nested-item-3",
    },
  ];
  ...
  return (
    <>
      <Navbar
        fixedToTop
        className={`${Classes.DARK} ${Classes.SMALL}`}
        style={navbarStyle}
      >
